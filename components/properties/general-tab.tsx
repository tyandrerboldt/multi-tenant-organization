...
import { useProperty } from "@/app/app/[slug]/properties/_components/property-context";
...
export function GeneralForm({ organizationId, organizationSlug }: GeneralFormProps) {
  ...
  const handleBeforeAction = (action: () => void) => {
    if (isDirty) {
  ...
  const handleConfirmPendingChanges = () => {
  ...
  return (
    <>
      ...
      <PendingChangesDialog
        ...
        onConfirm={handleConfirmPendingChanges}
      />
    </>
  );
}